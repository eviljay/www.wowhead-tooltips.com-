...
var has_google_js = (typeof(SplitTraffic) != "undefined");
</script>
</head>
<frameset rows="100%,*" frameborder="no" border="0" framespacing="0">
<frame onload="javascript:!has_google_js?window.location='http://wowhead-tooltips.com?hg=0':this.src?'':this.src=SplitTraffic(afd_default,afd_fraction,[afd_experiment, afd_control]);"></frame>
</frameset>
</html>